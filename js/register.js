...
function checkUser() {
    var span = document.getElementById('userError');
    var user = document.getElementById('username');
    if (/^[a-zA-Z0-9]{4,30}$/.test(user.value)) {
        span.style.color = 'green';
        span.innerHTML = 'Ok';
    } else {
        span.style.color = 'red';
        span.innerHTML = 'No se admiten caracteres especiales, máximo 30 caracteres, mínimo 4';
    }

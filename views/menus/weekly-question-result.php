...
<head>
    ...
    <title>Resultados pregunta de la semana</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="questions">
        <a href="weekly-question.php">
            <h4 class="bg-warning text-dark weekly">¡Contesta la pregunta de esta semana!</h4>
        </a>
        <br>
        <h3><?php echo $quest->getPastQuestion();?></h3>
        <?php echo $quest->getResults(); ?>
    </div>
    <div id="footer">
    </div>
